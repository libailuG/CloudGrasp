...
def generate_launch_description():
    ...
    return LaunchDescription([Node(package='cloudgrasp_lab',executable='lab_task',parameters=[c.robot_description,c.robot_description_semantic,c.robot_description_kinematics,{'use_sim_time':True}],output='screen')])
