...
def generate_launch_description():
    ...
    return LaunchDescription([
      ...
      Node(package='ros_gz_sim', executable='create', arguments=['-name','cloudgrasp','-topic','robot_description','-allow_renaming','false'], output='screen'),
      ...
      Node(package='ros_gz_bridge', executable='parameter_bridge', arguments=['/clock@rosgraph_msgs/msg/Clock[gz.msgs.Clock','/camera/points@sensor_msgs/msg/PointCloud2[gz.msgs.PointCloudPacked','/camera/image@sensor_msgs/msg/Image[gz.msgs.Image','/camera/depth_image@sensor_msgs/msg/Image[gz.msgs.Image','/camera/camera_info@sensor_msgs/msg/CameraInfo[gz.msgs.CameraInfo'], parameters=[sim], output='screen'),
